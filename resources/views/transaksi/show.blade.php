                ...
                <div class="col-12">
                  <div class="card">
                    ...
                    <div class="form-group">
                            <div class="col-md-6">
                                <img width="200" height="200" @if($data->villa->cover) src="{{ asset('images/villa/'.$data->villa->cover) }}" @endif />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="customer_id" class="col-md-4 control-label">villa</label>
                            <div class="col-md-6">
                                <input id="villa" type="text" class="form-control" readonly="" value="{{$data->villa->nama_villa}}">
