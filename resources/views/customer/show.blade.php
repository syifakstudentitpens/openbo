                    ...
                    <div class="card-body">
                      ...
                      <form class="forms-sample">
                        ...
                        <div class="form-group{{ $errors->has('pekerjaan') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                            <select class="form-control" name="pekerjaan" required="" disabled="">
                                <option value=""></option>
                                <option value="TI" {{$data->pekerjaan === "PN" ? "selected" : ""}} >PNS</option>
                                <option value="SI" {{$data->pekerjaan === "WR" ? "selected" : ""}} >Wirasawasta</option>
                                <option value="KM" {{$data->pekerjaan === "LN" ? "selected" : ""}} >Lainnya</option>
                            </select>
                            </div>
                        </div>
